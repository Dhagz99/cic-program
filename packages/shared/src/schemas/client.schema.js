...
export const updateClientSchema = z.object({
    ...
    civilStatus: z
        ...
        .number()
        .int()
        .positive("Civil status is required"),
...
export const updateLoanSchema = z.object({
    ...
    contractStartDate: z
        .string()
        .optional(),
    contractRequestDate: z
        .string()
        .optional(),
    contractEndPlannedDate: z
        .string()
        .optional(),
    contractEndActualDate: z
        .string()
        .optional(),
    firstPaymentDate: z
        .string()
    ...
    outstandingBalance: z
        .number()
        .optional(),
    overduePaymentAmount: z
        .number()
        .optional(),
    outstandingPaymentNumber: z
        .number()
        .optional(),
    overduePaymentNumber: z
        .number()
        .optional(),
    paymentPeriodicity: z
        .string()
        .optional(),
    paymentMethod: z
        .string()
